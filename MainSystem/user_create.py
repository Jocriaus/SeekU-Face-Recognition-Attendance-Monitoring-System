...
class CreateUserApp:
    ...
    #Contains-the-edit-label-and-entry-widgets--------------------------------------------------------------------------------------------------------- 
        ...
        self.register_user_button.bind(
            "<ButtonPress>", self.register_user, add="")
        ...
        self.username_label.place(
            anchor="center", relx=0.385, rely=0.15, x=0, y=0)
        ...
        self.first_name_label.place(
            anchor="center", relx=0.39, rely=0.41, x=0, y=0)
        ...
        self.last_name_label.place(
            anchor="center", relx=0.39, rely=0.54, x=0, y=0)
        ...
        self.user_role_optionmenu = tk.OptionMenu(
            self.register_user_frame2, self.user_role_var, *__values, command=None)
        self.user_role_optionmenu.place(
            anchor="center", relwidth=0.4, relx=.5, rely=0.76, x=0, y=0)
        self.user_role_optionmenu.configure(font="{arial} 16",justify="left")
        self.user_role_options = self.register_user_app.nametowidget(self.user_role_optionmenu.menuname)
