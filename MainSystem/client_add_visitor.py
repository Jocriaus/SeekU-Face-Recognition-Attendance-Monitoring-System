...
class AddClientApp:
    def __init__(self, vid_source, login_mod, sel_cam, home_mod, ):
        ...
        # build ui
        self.add_client_app = tk.Toplevel()
        self.add_client_app.configure(
            background="#F7FAE9", height=200, width=200)
        width= self.add_client_app.winfo_screenwidth()               
        height= self.add_client_app.winfo_screenheight() 
        self.add_client_app.geometry("%dx%d" % (width, height))
        self.add_client_app.resizable(False, False)


#-----------------------------------------------------------------------------------------
        self.add_client_frame3 = tk.Frame(self.add_client_app)
        self.add_client_frame3.configure(
            background="#0072bc", height=200, width=200)
        self.camera_canvas = tk.Canvas(self.add_client_frame3)
...
#-----------------------------------------------------------------------------------------
        self.add_client_frame2 = tk.Frame(self.add_client_app)
        self.add_client_frame2.configure(
            background="#F7FAE9", height=200, width=200)
        self.app_name_labelS = tk.Label(self.add_client_frame2)
        ...
        self.app_name_labelU = tk.Label(self.add_client_frame2)
        ...
        self.app_logo_label = tk.Label(self.add_client_frame2)
        ...
        self.sign_out_button = tk.Button(self.add_client_frame2)
...
#-----------------------------------------------------------------------------------------            
        self.add_client_frame = tk.Frame(self.add_client_app)
        self.add_client_frame.configure(
            background="#F7FAE9", height=200, width=200)
        self.snapshot_button = tk.Button(self.add_client_frame)
        ...
        self.school_logo_label = tk.Label(self.add_client_frame)
        ...
        self.school_logo_label.place(
            ...
            relx=.5,
            rely=0.12)
        self.last_name_label = tk.Label(self.add_client_frame)
        ...
        self.last_name_entry = tk.Entry(self.add_client_frame)
        ...
        self.first_name_label = tk.Label(self.add_client_frame)
        ...
        self.first_name_entry = tk.Entry(self.add_client_frame)
        ...
        self.contact_no_label = tk.Label(self.add_client_frame)
        ...
        self.contact_no_entry = tk.Entry(self.add_client_frame)
        ...
        self.address_label = tk.Label(self.add_client_frame)
        ...
        self.address_entry = tk.Entry(self.add_client_frame)
