...
class dbQueries:
    ...
    def create_personnel_report(self):
        ...
        insert_query_attendance = f"INSERT INTO tbl_personnel_attendance (personnel_attendance_no, personnel_no, personnel_attendance_date, personnel_time_in,personnel_time_out) VALUES ( ?, ?, ?, ?, ?)"
    ...
    def create_visitor_report(self):
        ...
        insert_query_attendance = f"INSERT INTO tbl_visitor_attendance (visitor_attendance_no, visitor_no, visitor_attendance_date, visitor_time_in,visitor_time_out) VALUES ( ?, ?, ?, ?, ?)"
        self.cursor.executemany(insert_query_attendance,modified_rows)
        self.connection.commit()
