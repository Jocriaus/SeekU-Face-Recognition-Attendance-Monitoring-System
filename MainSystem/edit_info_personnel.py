...
class EditPersonnelApp:
    ...
    #PRE-LOAD-ASSIGNMENT-------------------------------------------------------------------------------------------
        ...
        self.register_personnel_app.title("SeekU - Admin Edit Personnel Info")
        ...
        self.register_pers_frame3.configure(
            background="#F7FAE9", height=200, width=200)
        ...
        self.register_pers_frame2.configure(
            background="#F7FAE9", height=200, width=200)
        ...
        self.register_pers_label.configure(
            ...
            font="{arial} 28 {bold}",
            text='Edit Personnel')
        self.register_pers_label.place(
        ...
        self.personnel_num_label.configure(
            ...
            font="{arial} 20 {bold}",
            text='Personnel No.')
        self.personnel_num_label.place(
            anchor="center", relx=0.36, rely=0.125, x=0, y=0)
        ...
        self.contact_num_label.place(
            anchor="center", relx=0.33, rely=0.6, x=0, y=0)
        ...
        self.personnel_optionmenu = tk.OptionMenu(
            self.register_pers_frame2, self.personnel_type_var, *__values)
        ...
        self.personnel_options = self.register_personnel_app.nametowidget(self.personnel_optionmenu.menuname)
        ...
        self.address_label.place(
            anchor="center", relx=0.295, rely=0.695, x=0, y=0)
        ...
        self.address_entry.place(
            ...
            x=0,
            y=0)
        self.save_changes_button = tk.Button(self.register_pers_frame2)
        ...
        self.edit_changes_button = tk.Button(self.register_pers_frame2)
        ...
        self.register_pers_frame1.configure(
