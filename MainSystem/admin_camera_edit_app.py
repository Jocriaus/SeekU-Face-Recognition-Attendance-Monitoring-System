    ...
    def take_pic_func(self):
        ...
        if ret:
            ...
            if self.window_will_open == "Manage Students":
                rS.RegisterStudentApp(self.video_source, self.login_window, self.sel_cam_window, 
                                      self.admin_home_window, self.snapshot_app, self.img_path)
            elif self.window_will_open == "Manage Personnels":
                rP.RegisterPersonnelApp(self.video_source, self.login_window, self.sel_cam_window, 
                                      self.admin_home_window, self.snapshot_app, self.img_path)    
            elif self.window_will_open == "Manage Visitors":
                cAV.AddVisitorApp(self.video_source, self.login_window, self.sel_cam_window, 
                                  self.admin_home_window, self.snapshot_app, self.img_path)
