...
class RegisterStudentApp:
    def __init__(self, cam_app, admin_hom, file_path, saveonly, refresh,condition):
        ...
        self.register_student_app.configure(background=self.complimentary_color_2, height=200, width=200)
        ...
        self.register_stud_frame4.configure(background=self.main_color, height=200, width=200)
        ...
        self.register_stud_frame3.configure(background=self.complimentary_color_2, height=200, width=200)
        ...
        self.register_stud_frame2.configure(background=self.complimentary_color_2, height=200, width=200)
        self.register_stud_label = tk.Label(self.register_stud_frame2)
        self.register_stud_label.configure(
            background=self.complimentary_color_2, font="{arial} 28 {bold}", text="Register Student"
        )
        ...
        self.register_stud_frame1.configure(background=self.sub_color, height=200, width=200)
