    ...
    def create_table(self):
        ...
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_personnel (
                ...
                personnel_firstname TEXT,
                personnel_lastname TEXT,
                personnel_middlename TEXT,
                personnel_contact_no TEXT,
                personnel_address TEXT,
                personnel_type TEXT,
                personnel_status TEXT
            );
        """)

        # Create table tbl_personnel_attendance
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_personnel_attendance (
                personnel_attendance_no INTEGER PRIMARY KEY AUTOINCREMENT,
                personnel_no TEXT,
                personnel_attendance_date DATE,
                personnel_time_in TIME,
                personnel_time_out TIME,
                FOREIGN KEY (personnel_no) REFERENCES tbl_personnel (personnel_no)
            );
        """)

        # Create table tbl_personnel_report
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_personnel_report (
                personnel_report_no INTEGER PRIMARY KEY,
                personnel_no TEXT,
                personnel_attendance_date DATE,
                personnel_time_in TIME,
                personnel_time_out TIME,
        ...
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_setting (
                setting_no INTEGER PRIMARY KEY AUTOINCREMENT,
                password_length INTEGER,
                login_attempt INTEGER,
                sem_end_setting DATE,
                face_recog_file_path TEXT,
                face_recog_date DATE,
                av_file_path TEXT,
                av_date DATE,
                today_date DATE,
                data_set_fldr TEXT,
        ...
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_student_attendance (
                student_attendance_no INTEGER PRIMARY KEY AUTOINCREMENT,
                student_no TEXT,
                student_attendance_date DATE,
                student_time_in TIME,
                student_time_out TIME,
                FOREIGN KEY (student_no) REFERENCES tbl_student (student_no)
            );
        """)

        # Create table tbl_student_report
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_student_report (
                student_report_no INTEGER PRIMARY KEY,
                student_no TEXT,
                student_attendance_date DATE,
                student_time_in TIME,
                student_time_out TIME,
        ...
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_visitor (
                visitor_no INTEGER PRIMARY KEY AUTOINCREMENT,
                visitor_firstname TEXT,
                visitor_lastname TEXT,
                visitor_contact_no TEXT,
        ...
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_visitor_attendance (
                ...
                visitor_no INTEGER,
                visitor_attendance_date DATE,
                visitor_time_in TIME,
                visitor_time_out TIME,
                FOREIGN KEY (visitor_no) REFERENCES tbl_visitor (visitor_no)
            );
        """)

        # Create table tbl_visitor_report
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS tbl_visitor_report (
                visitor_report_no INTEGER PRIMARY KEY,
                visitor_no INTEGER,
                visitor_attendance_date DATE,
                visitor_time_in TIME,
                visitor_time_out TIME,
    ...
    def login_entry(self, username, password):
        query = (f"""
            ...
            WHERE username COLLATE BINARY = ? 
                AND password COLLATE BINARY = ?
                AND user_status COLLATE BINARY = 'IsActive'
        """)
